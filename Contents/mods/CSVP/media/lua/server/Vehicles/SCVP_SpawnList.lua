if VehicleZoneDistribution then
    ...
    VehicleZoneDistribution.parkingstall.vehicles["Base.SC_CrownVictoriaCiv"] = {index = -1, spawnChance = 20};
    ...
    VehicleZoneDistribution.medium.vehicles["Base.SC_CrownVictoriaCiv"] = {index = -1, spawnChance = 10};
    ...
    VehicleZoneDistribution.medium.vehicles["Base.SC_K5BlazerCiv"] = {index = -1, spawnChance = 10};
    VehicleZoneDistribution.medium.vehicles["Base.SC_G30Van"] = {index = -1, spawnChance = 10};
