...
function F700ArmoredWindshield(player, part, elapsedMinutes)
    ...
    if (vehicle and string.find( vehicle:getScriptName(), "SC_FordF700ArmoredDunbar", "SC_FordF700ArmoredBrinks", "SC_FordF700ArmoredTransport", "SC_FordF700ArmoredPolice")) then
...
function F700ArmoredWindowRearRight(player, part, elapsedMinutes)
    ...
    if (vehicle and string.find( vehicle:getScriptName(), "SC_FordF700ArmoredDunbar", "SC_FordF700ArmoredBrinks", "SC_FordF700ArmoredTransport", "SC_FordF700ArmoredPolice")) then
        ...
        if (vehicle:getPartById("WindowRearRight"):getCondition() < 100) and (vehicle:getPartById("WindowRearRight"):getInventoryItem()) then
