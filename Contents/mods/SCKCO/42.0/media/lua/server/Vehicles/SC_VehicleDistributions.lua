...
VehicleDistributions.SC_MilitaryTruckBed = {
    rolls = 10,
    items = {
        "SCGLClothing.Bag_MediumALICEPack", 2,
        "SCGLClothing.Bag_LargeALICEPack",  2,
        "SCGLClothing.Bag_M5Medical",  2,
        "SCGLClothing.ANPRC77",  2,
        "SCGLItems.ANPRC126",  2,
        "SCGLWeapons.GIJerryCan_Gasoline",                 2,
        "SCGLWeapons.AmmoCan556X45_Full",                2,
        "SCGLWeapons.AmmoCan762X51_Full",                2,
        "SCGLWeapons.AmmoCan50BMG_Full",                 1,
        "SCGLWeapons.AmmoCan40MMHEDP_Full",                 1,
    }
}
...
VehicleDistributions.SC_MilitiaTruckBed = {
    ...
    items = {
        ...
        "SCGLClothing.Hat_M1HelmetNetting",                10,
        "SCGLClothing.Hat_M1HelmetBurlap",                10,
        "SCGLClothing.Bag_GIM17GasMaskBagHigh",                10,
        "SCGLWeapons.AmmoCan556X45_Full",                10,
        "SCGLWeapons.AmmoCan762X51_Full",                10,
        "SCGLWeapons.AmmoCan50BMG_Full",                 10,
        "SCGLWeapons.AmmoCan40MMHEDP_Full",                 5,
        "SCGLItems.GIJerryCan_Water",                 10,
        "SCGLItems.GIJerryCan_Gasoline",                 5,
        "SCGLItems.MCI_CaseLate",                 2,
        "SCGLItems.MCI_CaseEarly",                 2,
    }
}
...
--  MILITIA
-- ============================================================
addEntry("SC_DodgeM880",        VehicleDistributions.SC_Militia, { Survivalist, Prepper })
addEntry("SC_CUCVZhenjaEdition",       VehicleDistributions.SC_Militia, { Survivalist, Prepper })
