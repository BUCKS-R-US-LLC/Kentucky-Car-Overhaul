...
void main()
{
	...
	// Base paint: force body hue to TexturePainColor on paintable regions (low tex.a).
	...
	// Damage rendered natural (no paint-hue recolor); overlay keeps body tint.
	col = mix(col, texColorDamage1Shell.xyz*lighting, texColorDamage1Shell.a*t2en);
	col = mix(col, texColorDamage1Overlay.xyz*lighting*TintColourNew, texColorDamage1Overlay.a*t2en);

	col = mix(col, texColorDamage2Shell.xyz*lighting, texColorDamage2Shell.a*t3en);
