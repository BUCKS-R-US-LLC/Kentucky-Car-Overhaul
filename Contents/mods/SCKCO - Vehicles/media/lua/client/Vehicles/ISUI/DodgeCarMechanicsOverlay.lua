ISCarMechanicsOverlay.CarList["Base.SC_M880"] = {imgPrefix = "powerwagon_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_M880Bubba"] = {imgPrefix = "powerwagon_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_M880Militia"] = {imgPrefix = "powerwagon_", x=0,y=0};
