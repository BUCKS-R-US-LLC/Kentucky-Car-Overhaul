...
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoria92MuhlenSheriff"] = {imgPrefix = "crownvic92_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoria92LouisvillePolice"] = {imgPrefix = "crownvic92_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoria85"] = {imgPrefix = "crownvic85_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoria85Taxi"] = {imgPrefix = "crownvic85_", x=0,y=0};
...
ISCarMechanicsOverlay.CarList["Base.SC_FordF700ArmoredDunbar"] = {imgPrefix = "f700dump_", x=0,y=0};
