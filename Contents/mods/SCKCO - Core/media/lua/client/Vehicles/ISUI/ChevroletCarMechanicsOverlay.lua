...
ISCarMechanicsOverlay.CarList["Base.SC_ChevroletK10FireLV"] = {imgPrefix = "k10_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_ChevroletK10FireWP"] = {imgPrefix = "k10_", x=0,y=0};
