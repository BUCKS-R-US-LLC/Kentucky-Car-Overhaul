...
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaJefferson92"] = {imgPrefix = "crownvic92_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaWarren92"] = {imgPrefix = "crownvic92_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaMuhlen92"] = {imgPrefix = "crownvic92_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaLVPD92"] = {imgPrefix = "crownvic92_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoria85"] = {imgPrefix = "crownvic85_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaTaxi85"] = {imgPrefix = "crownvic85_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaLVPD85"] = {imgPrefix = "crownvic85_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaStatePolice85"] = {imgPrefix = "crownvic85_", x=0,y=0};
ISCarMechanicsOverlay.CarList["Base.SC_FordCrownVictoriaParkRanger85"] = {imgPrefix = "crownvic85_", x=0,y=0};
