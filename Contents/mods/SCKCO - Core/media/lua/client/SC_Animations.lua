...
local vehicleToSeatAnimations = {
	...
	["Base.SC_ChevroletCapriceCiv"] = "Default",
	["Base.SC_ChevroletCaprice9C1StatePolice"] = "Default",
	["Base.SC_ChevroletCaprice9C1ParkRanger"] = "Default",
	["Base.SC_ChevroletCapriceLVPD"] = "Default",
